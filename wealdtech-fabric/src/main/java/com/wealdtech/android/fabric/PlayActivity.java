...
////    when(holder.editText1).encounters(focusLoss()).then(alert(onView(holder.editText1), "Lost focus"));
////    when(holder.editText1).encounters(focusGain()).then(alert(onView(holder.editText1), "Gained focus"));
////    when(holder.editText1).encounters(focusChange()).then(alert(onView(holder.editText1), "Before"));
...
////    when(holder.editText1).encounters(focusChange()).then(alert(onView(holder.editText1), "After"));
...
//
//    when(happens(click(holder.button2))).then(alert(holder.button2, "Hello"));
//    when(happens(longClick(holder.button2))).then(alert(holder.button2, "Ouch"));
//    when(happens(change(fabricData(this, R.id.play_button_1, "count")))).then(alert(holder.button3, "Changed"));
//    when(happens(focusLost(holder.editText1))).then(validate(holder.button2, emailValidator(), alert(holder.button2, "Valid"), alert(holder.button2, "Invalid")));
//  }
}
