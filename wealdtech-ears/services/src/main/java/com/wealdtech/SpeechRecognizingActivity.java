...
import com.wealdtech.services.LanguageDetailsChecker;
import com.wealdtech.services.OnLanguageDetailsListener;
import com.wealdtech.services.SpeechRecognitionUtil;
...
public abstract class SpeechRecognizingActivity extends Activity implements RecognitionListener
{
  ...
  {
    Log.e(TAG, "weald in onActivityResult()");
